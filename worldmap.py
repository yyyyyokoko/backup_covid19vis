...
df_world['area'] = df_world['type'].map({0: 'Open', 0.5: 'Partial lockdown', 1: 'Full lockdown'})
...
lockdown_date = list(df_world.date.unique())
lockdown_date = sorted(lockdown_date, key=lambda date: datetime.datetime.strptime(date, "%m/%d/%y"))

#color_lock = [ "#99ccff", "#857aad", "#690a3d"]

#color_lock = [ "#6e6391", "#a3525c", "#ff3300"]
